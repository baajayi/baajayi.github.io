...
fetch(fishWeatherInfo)
    ...
    .then((jsObject) => {
        ...
        document.getElementById("fishtemp").textContent = jsObject.main.temp
        document.getElementById("fishspeed").textContent = (jsObject.wind.speed).toFixed(2)
...
if (fishtemp <= 50 && fishspeed > 3){
    const fishchill = 35.74 + (0.6215 * fishtemp) - (35.75 * (fishspeed^0.16)) + (0.4275 * fishtemp * (fishspeed^0.16))
